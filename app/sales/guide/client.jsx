...
const SECTIONS = [
  {
    ...
    cta: { href: '/sales/cps/new', label: 'Register a partner' },
  },
  {
    Icon: Mic,
    ...
    cta: { href: '/sales/visits/new', label: 'Log a visit' },
  },
  {
    Icon: Clock,
    ...
    cta: { href: '/sales/map', label: 'Open the map' },
  },
  {
    Icon: TrendingUp,
    title: 'Performance',
    ...
    cta: { href: '/sales/performance', label: 'View performance' },
  },
  {
    Icon: Package,
    title: 'Inventory',
    ...
    cta: { href: '/sales/inventory', label: 'Manage inventory' },
  },
  {
    Icon: CalendarClock,
    title: 'Follow-ups',
    ...
    cta: { href: '/sales', label: 'See follow-ups' },
  },
];
