...
// GET /api/sales/visits — the signed-in rep's visits (admins may pass ?rm_id to
...
// POST /api/sales/visits — log a field visit. Persists the manual form plus the
// uploaded audio URL with status='processing'; the browser then fires
// /api/sales/visits/[id]/process to transcribe + summarize.
